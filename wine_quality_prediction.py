...
from sklearn.model_selection import train_test_split #splits data into training sets#
from sklearn.ensemble import RandomForestClassifier #ml model#
from sklearn.metrics import classification_report, confusion_matrix, accuracy_score #evaluation matrics#
import streamlit as st #web app framework#
import numpy as np #numerical operations#

# --- Configuration ---
# Set a random seed for reproducibility
RANDOM_SEED = 42 #sets a fixed seed for reproduction this ensures the model produces the same results each time#
